...
void make_matrics_int(int **arr, const char *input) {
    int i = 0, j = 0, z = 0;
    char num[MAX_INPUT];
    int num_index = 0;
...
void make_matrics_float(double **arr, const char *input) {
    int i = 0, j = 0, z = 0;
    char num[MAX_INPUT];
    int num_index = 0;
...
void make_matrics_complex(double complex **arr, const char *input) {
    int i = 0, j = 0, z = 0;
...
int main() {
    while (1) {
        ...
        if (strcmp(input_1, "END") == 0 || strcmp(input_1, "end") == 0) {
            break;
        }
        get_row_column(input_1);
        pick(input_1);
        ...
        if (INT) {
            ...
            make_matrics_int(arr_int_1, input_1);
            ...
            make_matrics_float(arr_float_1, input_1);
            ...
            make_matrics_complex(arr_complex_1, input_1);
        }
        ...
        if (strcmp(input_2, "END") == 0 || strcmp(input_2, "end") == 0) {
            if (INT) {
        ...
        if (strcmp(input_2, "NOT") == 0 || strcmp(input_2, "not") == 0) {
            not(arr_int_1);
            print((void **)arr_int_1, 'i');
        }
        else if (strcmp(input_2, "TRANSPOSE") == 0 || strcmp(input_2, "transpose") == 0) {
            if (INT) {
            ...
            if (INT) {
                ...
                make_matrics_float(arr_float_2, input_2);
                ...
                make_matrics_complex(arr_complex_2, input_2);
            }
            ...
            switch (operation) {
                case 1:
                    if (strcmp(input_3,"ADD") == 0 || strcmp(input_3, "add") == 0) {
                        add((void **)arr_int_1, (void **)arr_int_2, 'i');
                        print((void **)arr_int_1, 'i');
                    }
                    else if (strcmp(input_3,"SUB") == 0 || strcmp(input_3, "sub") == 0) {
                        sub((void **)arr_int_1, (void **)arr_int_2, 'i');
                        print((void **)arr_int_1, 'i');
                    }
                    else if (strcmp(input_3, "AND") == 0 || strcmp(input_3, "and") == 0) {
                        and(arr_int_1,arr_int_2);
                        print((void **)arr_int_1, 'i');
                    }
                    else if (strcmp(input_3, "OR") == 0 || strcmp(input_3, "or") == 0) {
                        or(arr_int_1,arr_int_2);
                        print((void **)arr_int_1, 'i');
                    }
                    else if (strcmp(input_3, "MUL") == 0 || strcmp(input_3, "mul") == 0) {
            ...
            if (strcmp(input_3, "END") == 0 || strcmp(input_3, "end") == 0) {
                if (INT) {
